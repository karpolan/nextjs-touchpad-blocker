...
const S3_BUCKET_FILES = {
  exe: 'https://public-file-storage.s3.us-east-2.amazonaws.com/software/touchpad-blocker.exe',
  zip: 'https://public-file-storage.s3.us-east-2.amazonaws.com/software/touchpad-blocker.zip',
};
